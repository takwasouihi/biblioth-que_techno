...
require_once "./db copy.php"; //la connexion avec la bd
...
$id = $_GET['idForum'];
// echo $id_comm ; 
$sql1 = "SELECT * FROM forum where idForum=:idForum ";
...
while ($ms = $stmt1->fetch(PDO::FETCH_ASSOC)) {
  ...
  $nomForum = $ms['nomForum'];
  $type = $ms['typpe'];
  $date_Forum = $ms['date_creation'];
  $contenu = $ms['contenu'];
    ...
    <div class="p-t-80 p-b-124 bo5-r p-r-50 h-full p-r-0-md bo-none-md">
                  ...
                  <center> <font size="+2.5"> <text> <?php echo $contenu; ?></text></font></center>
								...
								<p>
                <center><text cols="30"> <?php echo $date_Forum; ?> <span class="m-r-6 m-l-4"></text></span></center>
									</span></p>	
                </div>
                ...
                <p>
								<center>	<text cols="30" rows="10"> <?php echo $type; ?> </text></p></center>
								</div>
...
$idForum = $_GET['idForum'];
  ...
  $commentaireC = $commentaireC->getCommentaireById($idForum);
