  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
          ...
          <li><a class="nav-link scrollto" href="connexion.php">Inscription</a></li>
          <li><a class="nav-link scrollto" href="Revues.php">Revues</a></li>
          <li><a class="nav-link scrollto" href="#services">Cours</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Actualit�s</a></li>
          <li><a class="nav-link scrollto" href="Evenements.php">Ev�nements</a></li>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1><span>ESPRIT</span>th�que<span>.</span></h1>
      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        ...
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="">Actualit�s</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-calendar-todo-line"></i>
            <h3><a href="">Ev�nements</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="bx bxl-dribbble"></i></div>
              <h4><a href="details-forumLivres.php">Livres</a></h4>
              <p>Discutez de vos meilleurs lectures, recommandez les ou posez vos questions par rapport aux livres.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="details-forumInfo.php">Informatiques</a></h4>
              <p>Posez vos questions si vous �tes bloqu�s sur un code ou n'importe quelle autre question qui ont un rapport avec ce sujet.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              <div class="icon"><i class="bx bx-tachometer"></i></div>
              <h4><a href="details-forumExamens.php">Examens</a></h4>
              <p>Posez vos questions si vous avez besoin d'aide ou n'importe quelle autre question qui ont un rapport avec ce sujet.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-world"></i></div>
              <h4><a href="details-forumRevision.php">R�visions</a></h4>
              <p>Des questions par rapport � des exercices de r�visions tels que les TDs.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-slideshow"></i></div>
              <h4><a href="details-forumAutres.php">Autres</a></h4>
              <p>Tout autre questions qui non rien � voir avec ces pr�c�dents sujets.</p>
            </div>
          </div>
        ...
        <div class="col-lg-8 mt-5 mt-lg-0">
          <form action="forms/create.php" method="post" role="form">
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                <input type="text" name="name" class="form-control" id="name" placeholder="maximum 20 caract�res" maxlength="20" required>
              </div>
            </div>
            <br>
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                <input type="text" name="fname" class="form-control" id="fname" placeholder="maximum 20 caract�res" maxlength="20" required>
              </div>
            </div>
            <br>
            <div class="row">
              ...
              <div class="col-md-6 form-group mt-3 mt-md-0">
                <input type="email" class="form-control" name="email" id="email" placeholder="Pr�nom.Nom@esprit.tn" pattern=".+@esprit.tn" required>
              </div>
            </div>
            <br>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 form-group">
                <td> Votre num�ro de t�l�phone: </td>
              </div>
              <div class="col-md-6 form-group mt-3 mt-md-0">
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group mt-3 mt-md-0">
                ...
                <select class="form-control" name="class" id="class">
                  <option value="pr">1 Ann�e</option>
                  <option value="dr">2 Ann�e</option>
                  <option value="tr">3 Ann�e</option>
                  <option value="qu">4 Ann�e </option>
                  <option value="ci">5 Ann�e</option>
            ...
            <div class="text-center"><button type="submit"> Cr�er Compte </button></div>
            <br>
          </form>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Contact:</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#"> <strong> T�l�phone:</strong> +216 55 622 768<br></a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#"><strong> Adresse:</strong> El Ghazela<br></a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#"><strong> Email:</strong> Esprith�que@esprit.tn <br></a></li>
