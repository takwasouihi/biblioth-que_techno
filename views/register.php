...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
          ...
          <li><a class="nav-link scrollto" href="#services">Livres</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Evènements</a></li>
          <li><a class="nav-link scrollto" href="#team">Cours</a></li>
          <li><a class="nav-link scrollto" href="Livres.php">Actualités</a></li>
            <li><a class="nav-link scrollto" href="connexion.php">Connexion</a></li>
        </ul>
